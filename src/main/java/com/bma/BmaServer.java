...
public class BmaServer {

    public static void main(String[] args) {
        SpringApplication.run(BmaServer.class, args);
    }
    /*
    *
    * <a style="background-color:black;
    * color:white;text-decoration:none;
    * padding:4px 6px;font-family:-apple-system,
    * BlinkMacSystemFont, &quot;San Francisco&quot;, &quot;
    * Helvetica Neue&quot;, Helvetica, Ubuntu, Roboto, Noto, &quot;Segoe UI&quot;,
    * Arial, sans-serif;font-size:12px;
    * font-weight:bold;line-height:1.2;
    * display:inline-block;border-radius:3px"
    * href="https://unsplash.com/@anniespratt?utm_medium=referral&amp;
    ...
    *         </svg></span><span style="display:inline-block;padding:2px 3px">Annie Spratt</span></a>
    *
    *
    *
